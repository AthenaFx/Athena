...
{
    public class DiagnosticsWebApplicationSettings : AppFunctionDefinition
    {
        public override string Name { get; } = "diagnostics_web";

        public string BaseUrl { get; private set; } = "_diagnostics";

        public DiagnosticsWebApplicationSettings AtUrl(string baseUrl)
        {
            BaseUrl = baseUrl;
