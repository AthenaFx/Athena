...
namespace Athena.Authorization
{
    ...
    {
        private readonly Func<RouterResult, string, IDictionary<string, object>, Task<AuthorizationResult>> _authorize;

        public RouteAuthorizer(
            Func<RouterResult, string, IDictionary<string, object>, Task<AuthorizationResult>> authorize)
        {
            _authorize = authorize;
        }

        public async Task<AuthorizationResult> IsAuthorized(IDictionary<string, object> environment, string identity)
        {
